...
const WIDTHS = { sm: 'max-w-sm', md: 'max-w-md', lg: 'max-w-lg', xl: 'max-w-2xl', full: 'max-w-6xl' } as const;
</script>
...
<template>
  <transition name="pop">
    ...
    >
      ...
      <div
        class="relative w-full bg-white rounded-2xl border border-paper-300/60 p-7"
